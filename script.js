            ...
            //!second ajax request in ajax request
                $.ajax({
                    ...
                    // console.log(response)
                     ...
                     $('#dayOneIcon').attr('src', '');
                     $('#dayOneIcon').attr("alt", '');
                    var iconURLDayOne = 'http://openweathermap.org/img/wn/' + iconDayOne + '@2x.png';
                    ...
                    //* adding the day to the second day
                     ...
                     $('#dayTwoIcon').attr('src', '');
                     $('#dayTwoIcon').attr("alt", '');
                     var iconURLDayTwo = 'http://openweathermap.org/img/wn/' + iconDayTwo + '@2x.png';
                     ...
                     var iconURLDayThree = 'http://openweathermap.org/img/wn/' + iconDayThree + '@2x.png';
                    ...
                    //* adding the day to the third day
                     ...
                     var iconURLDayFour = 'http://openweathermap.org/img/wn/' + iconDayFour + '@2x.png';
                     ...
                     var iconURLDayFive = 'http://openweathermap.org/img/wn/' + iconDayFive + '@2x.png';
